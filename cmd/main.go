...
import (
	...
	"github.com/cbosdo/uyuni-server-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(uyuniv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6a2b95c8.uyuni-project.org",
